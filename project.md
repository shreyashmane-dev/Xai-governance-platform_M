...
- fallback feature importance computation using model coefficients, feature importances, or permutation-style feature shuffling when SHAP is unavailable
...
The frontend uses Recharts for interactive charts and Framer Motion for animation and transitions. React Joyride provides a guided walkthrough capability to help new users understand the platform.
